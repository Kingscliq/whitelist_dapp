  ...
  return (
    <Fragment>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 h-screen">
        <aside className="lg:col-span-1 border-r border-primary/30 flex items-center justify-center">
          <WhiteListForm />
        </aside>
        <aside className="lg:col-span-2 flex items-center justify-center">
          <AccountList />
        </aside>
      </section>
    </Fragment>
